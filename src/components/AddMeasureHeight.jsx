  ...
  <>
    ...
    <div className={style.container}>
      ...
      <div className={style.valueContainer}>
        ...
        <div className={style.btnGroup}>
          <Link to="/add-measure-2"><button className={style.btnNext} type="button" name="previous">Prev</button></Link>
...
export default AddMeasureHeight;
